...
Notes
-----
The release is built with GCC and then "strip protond" to strip the debug
...
# Pick some path to install BDB to, here we create a directory within the proton directory
BDB_PREFIX="${REFF_ROOT}/db4"
mkdir -p $BDB_PREFIX
