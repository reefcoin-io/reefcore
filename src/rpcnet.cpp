...
UniValue getpeerinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"subver\": \"/Reef Core:x.x.x/\",  (string) The string version\n"
...
static UniValue GetNetworksInfo()
{
    ...
    for(int n=0; n<NET_MAX; ++n)
    {
        ...
        obj.push_back(Pair("proxy_randomize_creeftials", proxy.randomize_creeftials));
...
UniValue getnetworkinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"subversion\": \"/Reef Core:x.x.x/\", (string) the server subversion string\n"
